...
Shared, runtime-free **contracts** for the ryuzi monorepo: domain models (`Project`, `Session`, `Surface`), event types (`CoreEvent`), permission/approval types, and the `ControlPlaneApi` interface.
